...
parser.add_argument('-s', '--shell', help='use the specified shell command (e.g. "powershell -c")')
parser.add_argument('--pattern', help='pattern to identify webshell output (default: random)')
...
parser.add_argument('-H', '--header', nargs='*', default=[], help='additional HTTP headers')
